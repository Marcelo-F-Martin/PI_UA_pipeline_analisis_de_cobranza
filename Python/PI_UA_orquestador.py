...
# LIBRERIAS ADICIONALES DE TRABAJO: Descomente y ejecute la siguiente línea de ser necesario.

#%pip install pandas==3.0.1 requests==2.32.5 xlrd==2.0.2 SQLAlchemy==2.0.48 PyMySQL==1.1.2 cryptography==46.0.6 
...
# Verifique sus credenciales de acceso a su MySQL local.

usuario = "root"
host = "localhost"
puerto = "3306"

# Base de datos y tabla predefinidas.

bd_capa_uno = "cobranzas_capa_uno"
bd_capa_dos = "cobranzas_capa_dos"
tabla_temp = "temp_cobranzas"

# Acceso a los scripts SQL en el repositorio.
...
# Descargar el contenido de los scripts SQL
...
if respuesta_1.status_code == 200 and respuesta_2.status_code == 200 and respuesta_3.status_code == 200 and respuesta_4.status_code == 200:
    ...
    try:
        ...
        print(f"✅ Ingesta exitosa en tabla {tabla_temp}' de BD '{bd_capa_uno}':\n - {len(df_final_limpio)} registros insertados\n")
        ...
        print(f"✅ Movimiento de datos exitoso en BD '{bd_capa_uno}':  '{tabla_temp}' => 'fact_cobranzas'\n")
        ...
        print(f"✅ Stored Procedure 'llenar_calendario' creado exitosamente en BD '{bd_capa_uno}'\n")        
        ...
        print(f"✅ Vistas creadas exitosamente en BD '{bd_capa_dos}'\n")
